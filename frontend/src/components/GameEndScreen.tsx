...
export const GameEndScreen: FC<GameEndScreenProps> = ({ players }) => {
            ...
            <div className="w-full max-w-md rounded-lg bg-white p-8 text-center shadow-xl">
                ...
                <ul className="space-y-3">
                    {sortedPlayers.map((player, index) => (
                        <li key={player.id} className="flex items-center justify-between rounded-md bg-gray-100 p-3 text-lg shadow-sm">
                            <span className="flex items-center">
                                <span className="mr-3 w-6 text-xl">{getMedal(index)}</span>
