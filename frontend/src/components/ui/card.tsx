...
const Card: Component<ComponentProps<'div'>> = (props) => {
    ...
    return (
        <div
            data-slot="card"
            class={cn(
                'rounded-base border-border bg-background font-base text-foreground shadow-shadow flex flex-col gap-6 border-2 py-6',
                local.class
            )}
            {...others}
        />
...
const CardFooter: Component<ComponentProps<'div'>> = (props) => {
    ...
    return (
        <div
            ...
            class={cn(
                'flex items-center px-6 pt-0 [.border-t]:pt-6',
                local.class
            )}
            {...others}
        />
